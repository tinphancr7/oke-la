...
const Tournament = () => {
	...
	const renderTab = () => {
		switch (tab) {
						...
						<div className="rounded-xl shadow bg-[#F1F1F1] border border-[#E4E4E4] p-4 mb-6">
							...
							<div className="w-full pb-4 lg:block hidden">
								{leagueProfile?.currentRound && (
									<Pagination
										totalRound={leagueProfile?.totalRound}
										setRound={setRound}
										round={leagueProfile?.currentRound - 1}
									/>
								)}
							</div>
			...
			case 3:
				return <RankTable leagueId={leagueId} />;
			case 4:
				return (
					<div>
						<h2 className="uppercase font-bold text-red-500 py-4 text-lg">
