...
const CreateTipsWrapper = ({
  ...
  const ButtonOdds = (className: String, id: number, text: String, disable = false) => {
    return (
      <div
    ...
    <div className="p-4 bg-neutral-100 w-full">
      <div className="grid xl:grid-cols-3 md:gap-x-5 h-fit">
        ...
        <div className="col-span-2 w-full">
          {/* <LeaguePicker /> */}
          <div className="w-full flex-col justify-center items-center gap-6 inline-flex" id="create-tips-option">
